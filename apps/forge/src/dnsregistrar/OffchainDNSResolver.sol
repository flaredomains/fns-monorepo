...
import "fns/resolvers/profiles/IAddrResolver.sol";
import "fns/resolvers/profiles/IExtendedResolver.sol";
import "fns/resolvers/profiles/IExtendedDNSResolver.sol";
...
contract OffchainDNSResolver is IExtendedResolver {
    ...
    constructor(IENS _ens, DNSSEC _oracle, string memory _gatewayURL) {
        ens = _ens;
        oracle = _oracle;
