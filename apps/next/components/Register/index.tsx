          ...
          <div className="grid items-center w-full h-12">
            <div className="animate-pulse flex space-x-4">
              <div
                ...
                className="rounded-full bg-orange-300 h-4 w-4"
              ></div>
              <div className="flex-1 space-y-6 py-1 grid grid-cols-5">
                <div
                  data-test="Loading Alert"
                  className="h-2 bg-orange-300 rounded col-span-2"
                ></div>
                <div
                  data-test="Loading Alert"
                  className="h-2 bg-orange-300 rounded col-span-4"
                ></div>
              </div>
            </div>
          </div>
...
const StepTitle = () => {
  return (
    <>
      <div data-test="StepTitle" className="hidden items-center mt-12 lg:flex">
