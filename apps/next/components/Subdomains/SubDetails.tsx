        ...
        <div className="flex-col w-full pr-3">
          ...
          <div className="flex-col items-center w-full mb-6 lg:flex lg:flex-row">
            ...
            <div className="flex items-center mt-2 lg:mt-0">
              ...
              <Image
                className="h-4 w-4 cursor-pointer ml-4 hover:scale-125 transform transition duration-100 ease-out"
                src={Clipboard_copy}
                alt="FNS"
              />
            </div>
          ...
          <div className="flex-col items-center w-full mb-6 lg:flex lg:flex-row">
            ...
            <div className="flex-col items-center mt-2 lg:mt-0 lg:flex lg:flex-row">
              ...
              <button className="flex items-center px-3 py-2 border-2 border-[#F97316] rounded-lg mt-2 hover:scale-105 transform transition duration-100 ease-out lg:mt-0">
